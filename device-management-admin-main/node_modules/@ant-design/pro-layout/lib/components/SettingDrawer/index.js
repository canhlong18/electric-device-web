...
var Body = function Body(_ref) {
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    ...
    children: [(0, _jsxRuntime.jsx)("h3", {
      className: (0, _emotion.cx)("".concat(prefixCls, "-drawer-title"), (0, _emotion.css)(_templateObject || (_templateObject = (0, _taggedTemplateLiteral2.default)(["\n          margin-bottom: 12px;\n          font-size: 14px;\n          line-height: 22px;\n        "])))),
      children: title
    }), children]
  });
};
        ...
        switch (_context.prev = _context.next) {
          ...
          case 6:
            _configProvider.default.config({
              theme: {
                primaryColor: (0, _utils.genStringToTheme)(color) || '#1677FF'
              }
            });
...
var initState = function initState(urlParams, settings, onSettingChange) {
  ...
  if (_defaultSettings.defaultSettings.navTheme !== urlParams.navTheme && urlParams.navTheme) {
...
var SettingDrawer = function SettingDrawer(props) {
  ...
  return (0, _jsxRuntime.jsx)(_drawer.default, {
    ...
    handler: (0, _jsxRuntime.jsx)("div", {
      className: (0, _emotion.cx)("".concat(baseClassName, "-drawer-handle"), (0, _emotion.css)(_templateObject2 || (_templateObject2 = (0, _taggedTemplateLiteral2.default)(["\n              position: absolute;\n              top: 240px;\n              right: 300px;\n              z-index: 0;\n              display: flex;\n              align-items: center;\n              justify-content: center;\n              width: 48px;\n              height: 48px;\n              font-size: 16px;\n              text-align: center;\n              background-color: var(--ant-primary-color);\n              border-radius: 4px 0 0 4px;\n              cursor: pointer;\n              pointer-events: auto;\n            "])))),
    ...
    children: (0, _jsxRuntime.jsxs)("div", {
      className: (0, _emotion.cx)("".concat(baseClassName, "-drawer-content"), (0, _emotion.css)(_templateObject3 || (_templateObject3 = (0, _taggedTemplateLiteral2.default)(["\n            position: relative;\n            min-height: 100%;\n            .", "-list-item {\n              span {\n                flex: 1;\n              }\n            }\n          "])), antPrefix)),
      children: [(0, _jsxRuntime.jsx)(Body, {
        ...
        children: (0, _jsxRuntime.jsx)(_BlockCheckbox.BlockCheckbox, {
          prefixCls: baseClassName,
          list: [{
            key: 'light',
            title: formatMessage({
        ...
        prefixCls: baseClassName,
        children: (0, _jsxRuntime.jsx)(_ThemeColor.ThemeColor, {
          colorList: colorList,
        ...
        children: [(0, _jsxRuntime.jsx)(_divider.default, {}), (0, _jsxRuntime.jsx)(Body, {
        ...
        }), (0, _jsxRuntime.jsx)(_LayoutChange.LayoutSetting, {
          ...
          children: (0, _jsxRuntime.jsx)(_RegionalChange.RegionalSetting, {
            settings: settingState,
            changeSetting: changeSetting
          })
        }), (0, _jsxRuntime.jsx)(_divider.default, {}), (0, _jsxRuntime.jsx)(Body, {
