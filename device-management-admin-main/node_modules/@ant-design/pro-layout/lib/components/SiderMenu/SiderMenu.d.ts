...
export declare const defaultIconCss: (designToken: LayoutDesignToken) => string;
export declare const proLayoutTitleHide: string;
export declare const siderCss: string;
export declare const siderTitleViewCss: (designToken: LayoutDesignToken) => string;
/**
 * 渲染 title 和 logo
 *
 * @param props
