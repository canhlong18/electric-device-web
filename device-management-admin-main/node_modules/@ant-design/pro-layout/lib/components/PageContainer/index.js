...
var renderPageHeader = function renderPageHeader(content, extraContent, prefixedClassName) {
  ...
  return (0, _jsxRuntime.jsx)("div", {
    className: (0, _emotion.cx)("".concat(prefixedClassName, "-detail"), (0, _emotion.css)(_templateObject || (_templateObject = (0, _taggedTemplateLiteral2.default)(["\n          display: flex;\n          ", " {\n            display: block;\n          }\n        "])), sm)),
    children: (0, _jsxRuntime.jsx)("div", {
      className: (0, _emotion.cx)("".concat(prefixedClassName, "-main"), (0, _emotion.css)(_templateObject2 || (_templateObject2 = (0, _taggedTemplateLiteral2.default)(["\n            width: 100%;\n          "])))),
      children: (0, _jsxRuntime.jsxs)("div", {
        className: (0, _emotion.cx)("".concat(prefixedClassName, "-row"), (0, _emotion.css)(_templateObject3 || (_templateObject3 = (0, _taggedTemplateLiteral2.default)(["\n              display: flex;\n              width: 100%;\n              ", " {\n                display: block;\n              }\n            "])), md)),
        children: [content && (0, _jsxRuntime.jsx)("div", {
          className: (0, _emotion.cx)("".concat(prefixedClassName, "-content"), (0, _emotion.css)(_templateObject4 || (_templateObject4 = (0, _taggedTemplateLiteral2.default)(["\n                  flex: auto;\n                  width: 100%;\n                "])))),
          children: content
        }), extraContent && (0, _jsxRuntime.jsx)("div", {
          className: (0, _emotion.cx)("".concat(prefixedClassName, "-extraContent"), (0, _emotion.css)(_templateObject5 || (_templateObject5 = (0, _taggedTemplateLiteral2.default)(["\n                  flex: 0 1 auto;\n                  min-width: 242px;\n                  margin-left: 88px;\n                  text-align: right;\n\n                  ", " {\n                    margin-left: 0;\n                  }\n                  ", " {\n                    margin-left: 0;\n                    text-align: left;\n                  }\n                  ", " {\n                    margin-left: 20px;\n                  }\n                  ", " {\n                    margin-left: 44px;\n                  }\n                "])), sm, md, lg, xl)),
...
var ProPageHeader = function ProPageHeader(props) {
  var _breadcrumb$routes, _designToken$pageCont;
  ...
  return (0, _jsxRuntime.jsx)("div", {
    className: (0, _emotion.cx)("".concat(prefixedClassName, "-warp"), (0, _emotion.css)(_templateObject6 || (_templateObject6 = (0, _taggedTemplateLiteral2.default)(["\n          background-color: ", ";\n          .", "-tabs-nav {\n            margin: 0;\n          }\n          .", "-page-header{\n            padding-left: 40px;\n            padding-right: 40px;\n          }\n          .", "-page-header-heading-extra > * {\n            margin-left: 8px;\n          }\n        "])), (_designToken$pageCont = designToken.pageContainer) === null || _designToken$pageCont === void 0 ? void 0 : _designToken$pageCont.pageContainerBgColor, antdPrefixCls, antdPrefixCls, antdPrefixCls)),
...
var PageContainer = function PageContainer(props) {
  ...
  var containerClassName = (0, _classnames.default)(prefixedClassName, className, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-page-container-ghost"), true), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-page-container-with-footer"), footer), _classNames));
  var content = (0, _react.useMemo)(function () {
    return children ? (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [(0, _jsxRuntime.jsx)("div", {
        className: (0, _emotion.cx)("".concat(prefixedClassName, "-children-content"), (0, _emotion.css)(_templateObject7 || (_templateObject7 = (0, _taggedTemplateLiteral2.default)(["\n              margin: ", ";\n            "])), designToken.pageContainer.pageContainerContentMargin)),
        children: children
  ...
  }, [children, designToken.pageContainer.pageContainerContentMargin, prefixedClassName, value.hasFooterToolbar]);
  ...
  var loadingDom = (0, _react.useMemo)(function () {
    ...
    return (0, _jsxRuntime.jsx)(_PageLoading.PageLoading, (0, _objectSpread2.default)({}, spinProps));
  }, [loading]);
  ...
  return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [(0, _jsxRuntime.jsxs)("div", {
      style: style,
      className: (0, _emotion.cx)(containerClassName, fixedHeader && pageHeaderDom && (0, _emotion.css)(_templateObject8 || (_templateObject8 = (0, _taggedTemplateLiteral2.default)(["\n              .", "-affix {\n                .", "-warp {\n                  background-color: ", ";\n                }\n              }\n            "])), antdPrefixCls, prefixedClassName, designToken.pageContainer.pageContainerFixedBgColor)),
    ...
    }), footer && (0, _jsxRuntime.jsx)(_FooterToolbar.FooterToolbar, {
      prefixCls: prefixCls,
      children: footer
    })]
  });
